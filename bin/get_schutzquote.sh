...
# add header
sed -i.bak '1s/.*/YEAR_MONTH,Herkunftsland,Entscheidungen insgesamt,Ablehnungen,sonstige Erledigungen, bereinigte Schutzquote, BAMF-Schutzquote/' $OUTPUTDIR/${FILE_BASE}_quota.csv 
rm $OUTPUTDIR/${FILE_BASE}_quota.csv.bak
